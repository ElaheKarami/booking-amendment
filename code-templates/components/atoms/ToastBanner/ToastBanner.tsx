...
// Presentational toast banner (adapted from Docs/Templates/ToastBannerTemplate).
// Framework-agnostic: uses a plain <a> instead of next/link. Tokens per design.md.
